...
// the real Postgres-backed backend now serves (issue #126, #128). The
// worker still starts so non-migrated routes (CMS, growth, comments, …)
// keep using the in-browser Dexie store; the migrated routes fall through
